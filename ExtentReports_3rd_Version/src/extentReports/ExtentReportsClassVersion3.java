...
public class ExtentReportsClassVersion3 {
	...
	public void startReport() {
		...
		extent.setSystemInfo("Environment", "Local Laptop ");
		extent.setSystemInfo("User Name", "Venkaiah Chowdary Inampudi");

		htmlReporter.loadXMLConfig(new File(System.getProperty("user.dir")+"\\extent-config.xml"));
		htmlReporter.config().setDocumentTitle("Venkaiah Automation Report Title");
		htmlReporter.config().setReportName("No Report Name Available now");
